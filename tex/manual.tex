...
This template utilizes the \texttt{acronym} package, but eventually I would like to migrate to the use of \texttt{glossaries} which is continuing to be supported. 
...
And if we use it a second time, such as \ac{CRTBP}, only the abbreviation will appear.
