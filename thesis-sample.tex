...
analytically intractable equations using iterative methods.
Thus we show that the author could pass an undergraduate
class in numerical analysis.  In addition, a unique
extension to Brent's method is proposed that results in
slight improvements in convergence.}
